...
nuget pack ./src/Package.Template.nuspec -NoDefaultExcludes -OutputDirectory ./out -Version 1.2.0

# To install the template
dotnet new install ./out/Genocs.Library.Template.1.2.0.nupkg
...
dotnet new install Genocs.Library.Template::1.2.0
```
